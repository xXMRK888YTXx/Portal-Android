...
sealed interface AddNewDeviceScreenUiEvent : UiEvent {
    ...
    data object RequestBluetoothPermission : AddNewDeviceScreenUiEvent
    data object UpdateBluetoothState : AddNewDeviceScreenUiEvent
    data object EnableBluetooth : AddNewDeviceScreenUiEvent
    data object OpenBluetoothSettings : AddNewDeviceScreenUiEvent
    data class OnBluetoothDeviceSelected(val device: BluetoothDevice) : AddNewDeviceScreenUiEvent
}